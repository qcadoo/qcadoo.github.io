    ...
    <table class="changelog-table" border>
        ...
        <tr>
          ...
          <ul>
            <li>qcadoo WMS mobile:</li>
              <ul>
                <li>możliwość wydruku etykiety produktu z poziomu dokumentu PZ.</li>
              </ul>
          </ul>
        </td>
        </tr>
  ...
  <details>
    ...
    <table class="changelog-table" border>
        ...
        <tr>
          ...
          <td>
          <ul>
            <li>parametry zaopatrzenia - reorganizacja zakładek,</li>
            <li>WMS mobile - wydawanie całych nośników z magazynu.</li>
          </ul>
        </td>
        </tr>
    </table>
  ...
  <details>
    ...
    <table class="changelog-table" border>
        ...
        <tr>
          ...
          <td>
          <ul>
            <li>umożliwienie zostawienia komentarza w odebranej dostawie,</li>
            <li>data WMS i pracownik WMS w dokumencie PZ powstałym z aplikacji mobilnej,</li>
            <li>data WMS i pracownik WMS w dostawie,</li>
            <li>dostosowanie aplikacji qcadoo WMS mobile do Android 16.</li>
          </ul>
        </td>
        </tr>
    </table>
  ...
  <details>
    ...
    <table class="changelog-table" border>
        ...
        <tr>
          ...
          <td>
          <ul>
            <li>poprawki do dostaw w qcadoo WMS mobile,</li>
            <li>poprawki do etykiet.</li>
          </ul>
        </td>
        </tr>
    </table>
    ...
    <table class="changelog-table" border>
        ...
        <tr>
          ...
          <ul>
            ...
            <li>kolumna Inwentaryzacja w liście dokumentów.</li>
          </ul>
        </td>
        </tr>
    </table>
